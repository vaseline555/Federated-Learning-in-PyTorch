...
python3 main.py \
    ...
    --dataset CIFAR10 --init_type truncnorm \
    --split_type iid --test_size -1 \
    --model_name SimpleCNN --crop 24 --randhf 0.5 --randjit 0.1 --imnorm --hidden_size 64 \
    --algorithm fedavg --eval_fraction 1 --eval_type local --eval_every 1 --eval_metrics acc1 \
    --K 100 --R 280 --E 5 --C 0.1 --B 50 --beta 0.9999 \
...
python3 main.py \
    ...
    --dataset CIFAR10 --init_type truncnorm --init_gain 1e-4 \
    --split_type patho --test_size 0 \
    --model_name SimpleCNN --crop 24 --randhf 0.2 --randjit 0.4 --hidden_size 64 \
    --algorithm fedavg --eval_type local --eval_every 1 --eval_metrics acc1 \
    --K 100 --R 280 --E 5 --C 0.1 --B 50 --beta 0 \
