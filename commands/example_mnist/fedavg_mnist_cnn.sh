...
do
    ...
    do
        python3 main.py \
            --exp_name FedAvg_MNIST_CNN_IID_C$c_B$b --seed 42 --device cuda \
            --dataset MNIST \
            --split_type iid --test_fraction 0 \
            --model_name TwoCNN --resize 28 --hidden_size 200 \
            --algorithm fedavg --eval_type both --eval_every 1 \
...
do
    ...
    do
        python3 main.py \
            --exp_name FedAvg_MNIST_CNN_Patho_C$c_B$b --seed 42 --device cuda \
            --dataset MNIST \
