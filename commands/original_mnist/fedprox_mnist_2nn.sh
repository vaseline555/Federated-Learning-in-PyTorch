...
do
    ...
    do
        python3 main.py \
            --exp_name "FedProx_MNIST_2NN_IID_C${c}_B${b}" --seed 42 --device cuda \
            --dataset MNIST \
            --split_type iid --test_size 0 \
            --model_name TwoNN --crop 28 --hidden_size 200 \
...
do
    ...
    do
        python3 main.py \
            --exp_name "FedProx_MNIST_2NN_Patho_C${c}_B${b}" --seed 42 --device cuda \
            --dataset MNIST \
